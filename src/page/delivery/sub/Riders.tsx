      ...
      <div className="overflow-x-auto rounded-xl shadow-xl border border-gray-200">
        <table className="min-w-full text-sm bg-white">
          <thead className="bg-gray-100 text-gray-700 sticky top-0 shadow">
            <tr>
              {["Rider", "Contact", "Status", "Orders Today", "Last Assigned", "Actions"].map(
                (h) => (
          ...
          <tbody>
            {filteredRiders.length > 0 ? (
              filteredRiders.map((rider, index) => (
                <tr key={index} className="hover:bg-emerald-50 transition border-b last:border-none">
                  ...
                  {/* Orders */}
                  <td className="p-4 font-medium text-gray-700">{rider.ordersToday}</td>
                  ...
                  <td className="p-4 text-center">
                    <div className="flex items-center justify-center gap-2">
                      ...
                      {/* View */}
                      <button className="p-2 bg-blue-100 text-blue-700 rounded-lg hover:bg-blue-200 transition shadow-sm">
              ...
              <tr>
                <td colSpan={6} className="text-center p-5 text-gray-500 bg-gray-50">
                  No riders found.
                </td>
              </tr>
            )}
